...
function AdminDashboard (){
  return (
    ...
    <div className='header d-flex justify-content-around'>
      <div>
        <img className='img1 mt-1' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSjwLJEoWjHPl2qAJ8Vy9wN-LeSKFvZpCZU0gszYGL8&s" alt="" />
      </div>
      <div className=' dbname d-flex align-items-center'>
       <h1> Admin DashBoard </h1>
      </div>
      <div>
      <img className='img2 mt-1' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSjwLJEoWjHPl2qAJ8Vy9wN-LeSKFvZpCZU0gszYGL8&s" alt="" />
      </div>
    </div>
  ...
  <div className='d-flex a-side '>
    <div className='d-flex sidebar flex-column flex-shrink-3 text-white'>
     ...
     <br />
      <li className="side-nav-item text-dark" >
        <a href="" className="navlink text-white p-1 ">
 ...
 <div className="content container mx-5 mt-5 mb-2">
  <div className=" ad-cards row w-100 ">
    ...
    <h2 className='mt-3'>Alumnis <span className='mt-3 mx-5'><FaUser/></span></h2>
  
    </div>
    <div className='col-md-3 col text-white bg-warning d-flex justify-content-around px-3 py-3 rounded mx-4 mb-1'>
    <h2 className='mt-3 mx-1'>Events <span className='mt-3 mx-5'><FaCalendar/></span></h2>
    </div>
    <div className='col-md-3 col text-white bg-danger d-flex justify-content-around px-3 py-3 rounded'>
      <h2 className='mt-3 '>Feedback<span className='mt-3 mx-5'><FaComment /></span></h2>
